...
call javaapi#class('ComparisonCompactor', '', [
  \ javaapi#method(0,1,'ComparisonCompactor(', 'int, String, String)', ''),
  \ javaapi#method(0,1,'compact(', 'String)', 'String'),
  \ ])
...
call javaapi#class('JUnit4TestAdapter', 'Describable', [
  \ javaapi#method(0,1,'JUnit4TestAdapter(', 'Class<?>)', ''),
  \ javaapi#method(0,1,'JUnit4TestAdapter(', 'Class<?>, JUnit4TestAdapterCache)', ''),
  \ javaapi#method(0,1,'countTestCases(', ')', 'int'),
  \ javaapi#method(0,1,'run(', 'TestResult)', 'void'),
  \ javaapi#method(0,1,'getTests(', ')', 'List'),
...
call javaapi#class('JUnit4TestAdapterCache', 'HashMap', [
  \ javaapi#method(0,1,'JUnit4TestAdapterCache(', ')', ''),
  \ javaapi#method(1,1,'getDefault(', ')', 'JUnit4TestAdapterCache'),
  \ javaapi#method(0,1,'asTest(', 'Description)', 'Test'),
  \ javaapi#method(0,1,'getNotifier(', 'TestResult, JUnit4TestAdapter)', 'RunNotifier'),
  \ javaapi#method(0,1,'asTestList(', 'Description)', 'List'),
  \ ])

call javaapi#class('JUnit4TestCaseFacade', 'Describable', [
  \ javaapi#method(0,1,'toString(', ')', 'String'),
  \ javaapi#method(0,1,'countTestCases(', ')', 'int'),
  \ javaapi#method(0,1,'run(', 'TestResult)', 'void'),
  \ javaapi#method(0,1,'getDescription(', ')', 'Description'),
...
call javaapi#class('TestResult', '', [
  \ javaapi#field(0,0,'fFailures', 'List'),
  \ javaapi#field(0,0,'fErrors', 'List'),
  \ javaapi#field(0,0,'fListeners', 'List'),
